...
Route::group(['middleware' => 'api'], function ($router) {
	...
	//Prospectos
    //Listar
    Route::post('prospectos', 'ProspectoController@index')->name('prospecto.index');
     //Mostrar
    Route::get('prospectos/show/{id}', 'ProspectoController@show')->name('prospecto.show');
     //Registrar
    Route::post('prospectos/store', 'ProspectoController@store')->name('prospecto.store');
     //Editar
    Route::post('prospectos/update/{id}', 'ProspectoController@update')->name('prospecto.update');
     //Traer los datos para mostrar en editar
    Route::post('prospectos/get/{id}', 'ProspectoController@get')->name('prospecto.get');

	Route::post('prospectos/uploadFiles', 'ProspectoController@uploadFiles')->name('prospecto.uploadFiles');
