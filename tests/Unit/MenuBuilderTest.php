...
class MenuBuilderTest extends TestCase
{
    ...
    public function testThreeBeginDropdown()
    {
        ...
        $mb = new MenuBuilder();
        $mb->beginDropdown(1, 'href1', 'nameOne');
        $mb->endDropdown();
        $mb->beginDropdown(2, 'href2', 'nameTwo');
        $mb->endDropdown();
        $mb->beginDropdown(3, 'href3', 'nameThree');
        $mb->endDropdown();
        $result = $mb->getResult();
        $this->assertSame($provided, $result);
    }
    ...
    public function testLinkInDropdownInDropdown(){
        ...
        $mb = new MenuBuilder();
        $mb->beginDropdown(1, 'href1', 'name');
        $mb->beginDropdown(2, 'href2', 'nameOne');
        $mb->addLink(3, 'nameTwo', '/href');
        $mb->endDropdown();
        $mb->endDropdown();
        $result = $mb->getResult();
    ...
    public function testComplex(){
        ...
        $mb = new MenuBuilder();
        $mb->addTitle(1, 'name');
        $mb->beginDropdown(2, 'href1', 'nameOne');
        $mb->addLink(3, 'nameTwo', '/href');
        $mb->addLink(4, 'nameTwo', '/href');
        $mb->beginDropdown(5, 'href2', 'nameOne');
