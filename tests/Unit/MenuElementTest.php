...
class MenuElementTest extends TestCase
{
    ...
    public function testMenuStore(){
        ...
        $roleAdmin = Role::create(['name' => 'admin']);
        $user->assignRole($roleAdmin);
        $menuLangList = new MenuLangList();
        $menuLangList->name = 'English';
        $menuLangList->short_name = 'en';
        $menuLangList->is_default = true;
        $menuLangList->save();
        $menuLangList = new MenuLangList();
        $menuLangList->name = 'Polish';
        $menuLangList->short_name = 'pl';
        $menuLangList->save();
        $menulist = new Menulist();
        $menulist->name = 'test2';
        $menulist->save();
        ...
        $this->assertDatabaseHas('menus_lang',[
            'name' => 'test2',
            'lang' => 'en',
            'menus_id' => 1,
        ]);
    ...
    public function testMenuEdit(){
        ...
        $menus->save();
        $menusLang = new MenusLang();
        $menusLang->name = 'testLangEn';
        $menusLang->lang = 'en';
        $menusLang->menus_id = $menus->id;
        $menusLang->save();
        $menusLang = new MenusLang();
        $menusLang->name = 'testLangPl';
        $menusLang->lang = 'pl';
        $menusLang->menus_id = $menus->id;
        $menusLang->save();
    ...
    public function testMenuDelete(){
        ...
        $this->assertDatabaseMissing('menus_lang',['menus_id' => $menus->id]);
    }
